...
def inicializaceOkna():
    okno.title("Zad?n?")              # titulek 
    okno.geometry("300x200+400+100")  # velikost a umisteni 
    
def obsahOkna():   
    # label Jmeno               
    L1 = Label(okno, text="Jm?no:")   # vytvori label (popisek) 
    ...
    # label Prijmeni 
    L2 = Label(okno, text="P??jmen?:")   # vytvori label (popisek) 
    ...
    # button      
    B1 = Button(okno, text="V?sledek", bg="yellow", command=tisk)
                    # vytvori tlacitko
...
def tisk():            # provede po stisku tlacitka
    # label pro vystup                               
    L3 = Label(okno,text="cel? jm:", )# vytvori label 
